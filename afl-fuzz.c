...
static void write_stats_file(double bitmap_cvg, double stability, double eps) {
  ...
  fprintf(f,
          ...
          total_execs - last_crash_execs, exec_tmout, use_banner, orig_cmdline);
  /* ignore errors */
...
static void usage(u8* argv0) {
  SAYF(
      ...
      "score.\n"
      "                  <fast (default), coe, explore, lin, quad, or "
      "exploit>\n"
...
int main(int argc, char** argv) {
  ...
  SAYF(cCYA "afl-fuzz " cBRI VERSION cRST
            " by <lcamtuf@google.com>. Core bind by <peterRong96@gmail.com>\n");
  ...
  while ((opt = getopt(argc, argv, "+i:o:f:m:b:t:T:dnCB:S:M:x:Qp:")) > 0)
